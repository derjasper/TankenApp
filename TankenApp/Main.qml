        ...
        Page {
            ...
            head {
                ...
                contents: Column {
                    ...
                    Label {
                        text: Helper.fuelKeyToString(settings.type) + ", "+settings.rad.split(".")[0]+" "+stationModel.apiProps.unit.distance+", "+i18n.tr("sort by %1").arg(Helper.sortKeyToString(settings.sort))
                    }
                }
            }
